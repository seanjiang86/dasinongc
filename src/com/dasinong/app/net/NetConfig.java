...
public class NetConfig {
  ...
  public static Map<String, String> getRegisterParams(String userName, String password, String cellPhone, String address) {
    Map<String, String> paramsMap =
        getBaseParams(false, getTokenParams(Params.username, userName), getTokenParams(Params.password, password),
  ...
  public static Map<String, String> getBaseParams(boolean isNeedAuthToken, String... strs) {
    ...
    String sign =
        getCheckToken(getTokenParams(Params.stamp, stamp), isNeedAuthToken, getTokenParams(Params.token, token), strs);
...
//    Map<String, String> paramsMap = new HashMap<String, String>();
  ...
  public static Map<String, String> getLocationInfoParams(String latitude, String longitude) {
    Map<String, String> paramsMap =
        getBaseParams(false, getTokenParams(Params.latitude, latitude), getTokenParams(Params.longitude, longitude));
