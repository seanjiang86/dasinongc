		...
		for (final ItemEntity itemEntity : dataList) {
			...
			case 1 :
				...
				if (!TextUtils.isEmpty(itemEntity.picName)) {
					LoadUtils.getInstance().loadImage(adImage, "http://120.26.208.198:8080/ads/"+itemEntity.picName);
				}
...
//		ImageView icon = (ImageView) view.findViewById(R.id.banner_title_container_icon);
...
//			}
//		}
//		TextView title = (TextView) view.findViewById(R.id.banner_title_container_title);
...
//		ImageView icon = (ImageView) view.findViewById(R.id.banner_all_container_icon);
//		// if(!TextUtils.isEmpty(banner.data.picUrl)) {
//		// LoadUtils.getInstance().loadImage(icon, banner.data.picUrl);
//		// }
//
...
//		}
//
//		TextView title = (TextView) view.findViewById(R.id.banner_all_container_title);
//		title.setText(itemEntity.title);
//		TextView above = (TextView) view.findViewById(R.id.banner_all_container_content_above);
