...
public class FieldEntity extends BaseResponse {
    ...
    public static class CurrentFieldEntity {
        ...
        public int  workable;//不宜下地
        public int sprayable;//不宜打药
